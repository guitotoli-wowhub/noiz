    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative py-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl mb-4">Nossas soluções</h2>
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 h-full">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-2xl">{solucao.titulo}</h3>
                  </div>
            ...
            {exemplosAplicacao.map((useCase, index) => (
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 h-full flex flex-col">
                  <h3 className="text-xl mb-3">{useCase.titulo}</h3>
                  
                  <div className="mb-4 flex-1">
                    <p className="text-sm text-white/60 mb-2">
                      <span className="text-[#FF00FF]">Problema:</span> {useCase.problema}
                    </p>
                    <p className="text-sm text-white/60">
                      <span className="text-[#9D00FF]">Solução:</span> {useCase.solucao}
                    </p>
                  </div>
      ...
      <section className="relative py-24 px-4 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl mb-4">Integrações</h2>
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
      ...
      <section className="relative py-24 px-4 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl mb-4">Nossa stack tecnológica</h2>
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                  <div className="flex flex-col lg:flex-row gap-6">
                    <div className="lg:w-1/4">
                      <h3 className="text-2xl mb-2">{camada.camada}</h3>
            ...
            {processo.map((fase, index) => (
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 h-full">
                  ...
                  <h3 className="text-xl mb-2">{fase.titulo}</h3>
