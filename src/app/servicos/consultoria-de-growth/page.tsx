        ...
        <div className="min-h-screen bg-black text-white selection:bg-[#FF00FF]/30">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-24 pb-12">
                ...
                <div className="relative z-10 max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <h1 className="text-6xl md:text-7xl lg:text-8xl mb-6 bg-gradient-to-r from-[#9D00FF] via-white to-[#FF00FF] bg-clip-text text-transparent font-bold tracking-tight">
            ...
            <section className="relative py-24 px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl mb-4 font-bold">5 pilares do growth</h2>
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-8">
                                        <div className="flex-shrink-0 lg:w-1/3">
                                            <div className="flex items-center gap-4 mb-4">
                                                ...
                                                <div>
                                                    <h3 className="text-3xl mb-1 font-bold">{pilar.titulo}</h3>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {pilar.metricas.map((metrica, idx) => (
                                                        <span
                                                            key={idx}
                                                            className="px-3 py-1.5 bg-white/10 rounded-full text-sm font-mono border border-white/5"
                                                        >
                                                            {metrica}
                                                        </span>
                                                    ))}
            ...
            <section className="relative py-24 px-4 bg-white/[0.02]">
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl md:text-5xl mb-4 font-bold">Nossa metodologia</h2>
                        <p className="text-xl text-white/60 max-w-2xl mx-auto">
                            ...
                            >
                                ...
                                <div className="relative bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-8 h-full">
                                    <div className="flex items-start gap-4 mb-4">
                                        ...
                                        <div>
                                            <h3 className="text-2xl mb-1 font-bold">{fase.titulo}</h3>
                                    ...
                                    <div className="pt-4 border-t border-white/10">
                                        <span className="text-xs text-white/50">
                                            Duração: <span className="text-[#FF00FF] font-medium">{fase.duracao}</span>
                                        </span>
                                    </div>
                                </div>
                            </motion.div>
            ...
            <section className="relative py-24 px-4">
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl md:text-5xl mb-4 font-bold">Ferramentas & stack</h2>
                        <p className="text-xl text-white/60 max-w-2xl mx-auto">
            ...
            <section className="relative py-24 px-4 bg-white/[0.02]">
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl md:text-5xl mb-4 font-bold">Frameworks de growth</h2>
                        <p className="text-xl text-white/60 max-w-2xl mx-auto">
                        ...
                        {frameworks.map((framework, index) => (
                            ...
                            >
                                ...
                                <div className="relative bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                                    ...
                                    <h3 className="text-xl mb-2 font-bold">{framework.nome}</h3>
                        ...
                        {casosUso.map((caso, index) => (
                            ...
                            >
                                ...
                                <div className="relative bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                                    <h3 className="text-2xl mb-2 font-bold">{caso.tipo}</h3>
                                    <p className="text-sm text-white/60 mb-4">
                                        <span className="text-[#FF00FF] font-medium">Desafio:</span> {caso.desafio}
                                    </p>
